...
//             {data.map((item) => (
//               <tr key={item.id}>
//                 <td>{editMode && editData.id === item.id ? <input type="text" name="name" value={editData.name} onChange={handleChange} /> : item.name}</td>
//                 <td>{editMode && editData.id === item.id ? <input type="text" name="age" value={editData.age} onChange={handleChange} /> : item.age}</td>
//                 <td>{editMode && editData.id === item.id ? <input type="text" name="city" value={editData.city} onChange={handleChange} /> : item.city}</td>
//                 <td>
//                   {!editMode && (
//                     <>
